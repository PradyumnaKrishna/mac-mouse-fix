...
/// - All settings are stored in a dictionary inside a single keychain item labeled 'in.onpy.mac-mouse-fix.secure-storage'.
...
@objc class SecureStorage: NSObject {
    ...
    private static let label = "in.onpy.mac-mouse-fix.secure-storage" /// "MFSecureStorage"
