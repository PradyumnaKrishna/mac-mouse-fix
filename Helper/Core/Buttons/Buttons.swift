...
@objc class Buttons: NSObject {
    ...
    /// Ivars
    static var queue: DispatchQueue = DispatchQueue(label: "in.onpy.mac-mouse-fix.buttons", qos: .userInteractive, attributes: [], autoreleaseFrequency: .inherit, target: nil)
